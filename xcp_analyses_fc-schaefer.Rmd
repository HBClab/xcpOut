...
matrix_plot<- heatmap.2(a,symm=TRUE,col=new.palette(40),na.rm=TRUE,dendrogram="none",Rowv=FALSE,Colv=FALSE,
          trace="none", 
...
ggsave(filename="subnet_matrix-schaefer-400_dsn-acompcor.png",width=300,height=200,units=c("mm"),dpi=300)
